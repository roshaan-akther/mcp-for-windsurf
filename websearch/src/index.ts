  ...
  if (transportMode === "stdio") {
    ...
    app.post("/mcp", async (req: Request, res: Response) => {
      try {
        ...
        await (transport as StreamableHTTPServerTransport).handleRequest(req as any, res as any, body);
      } catch (err) {
    ...
    app.get("/mcp", async (req: Request, res: Response) => {
      try {
        await (transport as StreamableHTTPServerTransport).handleRequest(req as any, res as any);
      } catch (err) {
