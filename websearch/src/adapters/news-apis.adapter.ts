        ...
        content: [
          {
            ...
            text: JSON.stringify({
              ...
              articles: data.response.results.map((article: GuardianArticle) => ({
                id: article.id,
...
export const newsApisAdapter: Adapter = {
  name: "news-apis",
