...
const coinGeckoPricesTool: Tool = {
...
const coinGeckoTrendingTool: Tool = {
        ...
        content: [
          {
            ...
            text: JSON.stringify({
              source: "CoinGecko API",
              trending_coins: data.coins.map((coin: any) => ({
...
const alphaVantageStockTool: Tool = {
...
export const financeApisAdapter: Adapter = {
  name: "finance-apis",
