  ...
  handler: async ({ start_date, end_date, api_key }) => {
    try {
      ...
      Object.keys(data.near_earth_objects).forEach(date => {
        data.near_earth_objects[date].forEach((asteroid: Asteroid) => {
        ...
        content: [
          {
            ...
            text: JSON.stringify({
              ...
              photos: data.photos.map((photo: MarsPhoto) => ({
                id: photo.id,
                sol: photo.sol,
        ...
        content: [
          {
            ...
            text: JSON.stringify({
              ...
              launches: data.results.map((launch: SpaceLaunch) => ({
                id: launch.id,
                name: launch.name,
...
export const scienceApisAdapter: Adapter = {
  name: "science-apis",
