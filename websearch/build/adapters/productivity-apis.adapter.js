...
const jsonPlaceholderTodosTool = {
...
const jsonPlaceholderAlbumsTool = {
...
const jsonPlaceholderPhotosTool = {
...
const jsonPlaceholderCompleteTool = {
    ...
    handler: async ({ include_users, include_posts, include_comments, include_albums, include_photos, include_todos }) => {
        try {
            ...
            const promises = [];
            if (include_users) {
                promises.push(fetch('https://jsonplaceholder.typicode.com/users')
                    .then(res => res.json())
            ...
            if (include_comments) {
                promises.push(fetch('https://jsonplaceholder.typicode.com/comments')
                    .then(res => res.json())
                    .then(comments => { results.data.comments = comments; }));
            }
            if (include_albums) {
                promises.push(fetch('https://jsonplaceholder.typicode.com/albums')
                    .then(res => res.json())
                    .then(albums => { results.data.albums = albums; }));
            }
            if (include_photos) {
                promises.push(fetch('https://jsonplaceholder.typicode.com/photos')
                    .then(res => res.json())
                    .then(photos => { results.data.photos = photos; }));
            }
            if (include_todos) {
                promises.push(fetch('https://jsonplaceholder.typicode.com/todos')
                    .then(res => res.json())
...
const uuidGeneratorTool = {
    ...
    handler: async ({ count }) => {
        try {
            const promises = Array.from({ length: count }, () => fetch('https://httpbin.org/uuid').then(res => res.json()));
...
export const productivityApisAdapter = {
